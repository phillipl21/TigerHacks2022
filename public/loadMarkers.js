const features = [
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Hitt Street Parking Garage</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">University Avenue Parking Garage</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">WG16 Parking lot</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Conley Parking Garage</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Turner Avenue Parking Garage</h6>' +
        "<body><b>Parking restrictions are enforced 7 a.m.-6 p.m., Monday-Friday.</body>",
    }),
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Virginia Parking Garage</h6>' +
        "<body><b>Parking restrictions are enforced 7 a.m.-6 p.m., Monday-Friday." +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">WG10 Parking Lot</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Memorial Union Visitor Parking Lot</h6>' +
        "<body><b>Parking restrictions enforced 7 a.m.-6 p.m., Monday-Friday." +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">WC7 Parking Lot</h6>' +
        "<body><b>Parking restrictions enforced 7 a.m.-6 p.m., Monday-Friday." +
        "<br>This lot has metered parking during the day." +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">CG17 Parking Lot</h6>' +
        "<body><b>Parking restrictions enforced 7 a.m.-6 p.m., Monday-Friday." +
        "<br>This lot has metered parking during the day." +
        "<br>There is a kiosk that charges $1.25/hour.</body>",
    }),
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">CG2 Parking Lot</h6>' +
        "<body><b>Parking restrictions enforced 7 a.m.-6 p.m., Monday-Friday." +
        "<br>This lot has metered parking during the day." +
        "<br>There is a kiosk that charges $1.25/hour.</body>",
    }),
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Virginia Avenue Surface Lot</h6>' +
        "<body><b>Parking restrictions enforced 7 a.m.-6 p.m., Monday-Friday." +
        "<br>*This lot has metered parking during the day." +
        "<br>*There is a kiosk that charges $1.25/hour.</body>",
    }),
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">WG1 Parking Lot</h6>' +
        "<body><b>Parking restrictions are enforced 7 a.m.-6 p.m., Monday-Friday." +
        "<br>*This lot has metered parking during the day." +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Hitt Street Visitor Parking Lot</h6>' +
        "<body><b>Parking restrictions enforced 7 a.m.-6 p.m., Monday-Friday." +
        "<br>*This lot has metered parking during the day.</body>" +
        "<br>*There is a kiosk that charges $1.25/hour.</body>",
    }),
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Catalyst Café</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Bookmark Café</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Plaza 900 Dining</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Emporium</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Potential Energy Cafe</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        '<h6 style="font-family">Pizza/Breakfast & MO</h6>' +
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        ...
        "<body><b>Monday - Wednesday</b>" +
        "<br>8:00 am - 8:00 pm" +
        "<br><b>Thursday - Friday</b>" +
        "<br>8:00 am - 5:00 pm" +
        "<br><b>Saturday</b>" +
        "<br>10:00 am - 2:00 pm" +
        "<br><b>Sunday</b>" +
        "<br>12:00 pm - 8:00 pm</body>",
    }),
  },
  {
    // Wheatstone
  ...
  },
  {
    ...
    content: new google.maps.InfoWindow({
      content:
        ...
        "<body><b>Monday - Thursday</b>" +
        "<br>7:15 am - 10:00 am (Breakfast)" +
        "<br>11:00 am - 2:00 pm (Lunch)" +
        "<br>5:00 pm - 9:30 pm (Dinner)</body>" +
        "<br><b>Friday</b>" +
        "<br>7:15 am - 10:00 am (Breakfast)" +
        "<br>11:00 am - 2:00 pm (Lunch)" +
        "<br>5:00 pm - 7:00 pm (Dinner)</body>" +
        "<br><b>Saturday</b>" +
        "<br>11:00 am - 4:00 pm (Lunch)" +
        "<br><b>Sunday</b>" +
        "<br>11:00 am - 2:00 pm (Lunch)" +
        "<br>5:00 pm - 7:30 pm (Dinner)</body>",
    }),
  },
  {
...
export function activateMarker(map, name) {
  console.log("function entered", name);
